...
class Lista {
    ...
    public:
        ...
        * contarElementos() + 1  */
        ...
        /*
        El método avanzar cursor permite el movimiento de un nodo al siguiente usando
        el cursor
        ...
        El valor de retorno indica si el cursor quedó posicionado sobre un  elemento o
        no (en caso de que la Lista esté vacía o no existan más elementos por
        recorrer.)
        */
        bool avanzarCursor();

        /*  pre : el cursor está posicionado sobre un elemento de la Lista (fue
        invocado el método     avanzarCursor() y devolvió true) post: devuelve el
...
// Ahora, las definiciones de los métodos
template <class T> 
Lista<T>::Lista() {
    this->primero = NULL;
    this->tamanio = 0;
